...
export const translations = {
  ...
  channelsPage: {
    ...
    developer: {
      ...
      desc: { en: "SSV provides a clean, intuitive API that makes channel integration effortless. One endpoint per channel, consistent response formats, and comprehensive documentation.", fr: "SSV fournit une API propre et intuitive qui rend l'intégration des canaux sans effort. Un endpoint par canal, formats de réponse cohérents et documentation complète." },
