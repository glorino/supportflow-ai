...
const features = [
  ...
  },
  {
    ...
    title: "Unified Inbox",
    desc: "All channels in one conversation thread",
    bullets: ["WhatsApp, Email, SMS & Web Chat", "Cross-channel context preserved", "Single agent workspace"],
  },
  {
    color: "purple",
    ...
    desc: "Real-time emotion detection across every interaction",
    bullets: ["Live tone & urgency scoring", "Angry customer auto-escalation", "99.7% detection accuracy"],
  },
  {
    color: "amber",
    ...
    desc: "Automated escalation when SLAs are breached",
    bullets: ["24/7 pipeline monitoring", "Slack & SMS alert escalation", "Full audit trail per ticket"],
  },
  {
    color: "cyan",
    ...
    desc: "Auto-digested searchable knowledge for agents",
    bullets: ["Semantic search across tickets", "AI-powered answer suggestions", "Continuous auto-ingestion"],
  },
  {
    color: "rose",
    ...
    desc: "Live dashboards and custom metrics at a glance",
    bullets: ["Custom KPI dashboards", "Ticket resolution heatmaps", "Performance trend analysis"],
  },
];
      ...
      <section className="relative py-24 bg-gradient-to-br from-[#0b1a2e] via-[#0f2340] to-[#142d50] overflow-hidden">
        ...
        <div className="max-w-[800px] mx-auto px-6 text-center relative">
          <RevealSection>
            ...
            <p className="text-gray-300/80 text-lg mb-10">Start resolving tickets with AI in minutes, not months.</p>
