...
function DashboardHeader() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-30 h-16 border-b border-gray-200/80 bg-white/80 backdrop-blur-xl">
        <div className="flex h-full items-center justify-between px-4 sm:px-6">
          {/* Left - Mobile Menu + Search */}
          <div className="flex items-center gap-3 flex-1">
            <button
              onClick={() => setMobileMenuOpen(true)}
              className="lg:hidden h-9 w-9 rounded-xl hover:bg-gray-100 flex items-center justify-center text-gray-500 transition"
            >
            ...
            <div className="relative max-w-md w-full">
              ...
              />
              <kbd className="absolute right-3 top-1/2 -translate-y-1/2 rounded-md border border-gray-200 bg-white px-1.5 py-0.5 text-[10px] font-medium text-gray-400 hidden sm:inline-flex">⌘K</kbd>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            {/* AI Status */}
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 mr-2">
            ...
            <button className="h-9 w-9 rounded-xl hover:bg-gray-100 flex items-center justify-center text-gray-500 hover:text-gray-700 transition relative">
              ...
              <span className="absolute -top-0.5 -right-0.5 h-4 w-4 rounded-full bg-gradient-to-br from-red-500 to-red-600 text-[9px] font-bold text-white flex items-center justify-center shadow-sm">3</span>
            </button>
            ...
            <button className="h-9 w-9 rounded-xl hover:bg-gray-100 flex items-center justify-center text-gray-500 hover:text-gray-700 transition relative">
              ...
              <span className="absolute -top-0.5 -right-0.5 h-4 w-4 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-[9px] font-bold text-white flex items-center justify-center shadow-sm">5</span>
            </button>

            {/* User Menu */}
            <div className="flex items-center gap-2 ml-2 pl-2 border-l border-gray-200">
              <button onClick={logout} className="flex items-center gap-2.5 rounded-xl p-1.5 hover:bg-gray-100 transition group" title="Click to logout">
                <div className={`relative h-9 w-9 rounded-xl bg-gradient-to-br ${badge.gradient} flex items-center justify-center text-white text-xs font-bold shadow-md group-hover:shadow-lg transition-shadow`}>
                ...
                <div className="text-left hidden sm:block">
                  ...
                  <div className="text-[11px] text-gray-400 flex items-center gap-1.5">
                    <span className={`inline-flex items-center rounded-full px-1.5 py-0.5 text-[9px] font-semibold border ${badge.color}`}>{badge.label}</span>
                  </div>
                </div>
