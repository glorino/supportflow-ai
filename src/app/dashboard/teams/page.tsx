            ...
            <tbody className="divide-y divide-gray-50">
              {agents.map((a) => (
                <tr key={a.id} className="hover:bg-gray-50/50 transition-colors group">
                  ...
                  <td className="hidden sm:table-cell px-6 py-4 text-sm text-gray-600">{a.team}</td>
                  <td className="px-6 py-4">
                  ...
                  <td className="hidden sm:table-cell px-6 py-4 text-sm font-medium text-gray-900">{a.tickets}</td>
                  <td className="hidden sm:table-cell px-6 py-4 text-sm text-gray-600">{a.resolved}</td>
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1.5">
