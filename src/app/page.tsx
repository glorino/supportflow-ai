        ...
        <div className="max-w-[800px] mx-auto px-6 text-center relative">
          <RevealSection>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/pricing" className="inline-flex items-center justify-center gap-2 px-10 py-4 border-2 border-blue-300/30 text-blue-200 rounded-2xl text-[15px] font-semibold hover:bg-white/5 transition-all hover:scale-[1.02] active:scale-[0.98]">
                {t("cta.start")}
              </Link>
            </div>
          </RevealSection>
